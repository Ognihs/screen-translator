...
def test_check_returns_false_on_first_image():
    ...
    checker = StabilityChecker(window_size=3, mse_threshold=50.0)
...
def test_check_mse_at_exact_threshold():
    ...
    checker = StabilityChecker(window_size=2, mse_threshold=0.0)
...
def test_reset_clears_state():
    ...
    checker = StabilityChecker(window_size=2, mse_threshold=50.0)
...
def test_content_changed_first_call_returns_true():
    ...
    checker = StabilityChecker(window_size=2, mse_threshold=50.0, change_threshold=1.0)
...
def test_content_changed_with_zero_threshold_always_true_after_first():
    ...
    checker = StabilityChecker(window_size=2, mse_threshold=50.0, change_threshold=0.0)
    checker.update_reference(_make_png((0, 0, 0)))
    # 任何非零差异都应返回 True
